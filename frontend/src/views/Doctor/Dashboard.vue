...
<div style="background: linear-gradient(to right, #ccccff, #66ccff, #ff8566, #ccccff, #ff8566); min-height:100vh;">
  ...
  <!-- HEADER -->
  <header class="navbar d-flex align-items-center justify-content-between shadow px-4" style="background:white">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <ul v-if="todaysAppointments.length" class="list-group">
          <li v-for="a in todaysAppointments"
              :key="a.id"
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <ul v-if="upcomingAppointments.length" class="list-group">
          <li v-for="a in upcomingAppointments"
              :key="a.id"
              class="list-group-item d-flex justify-content-between align-items-center">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <ul v-if="pastAppointments.length" class="list-group">
          <li v-for="a in pastAppointments"
              :key="a.id"
              class="list-group-item d-flex justify-content-between align-items-center">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <div v-if="missingDates.length">
          ...
          <router-link to="/doctor/manage-slots"
        ...
        <div v-else>
          <p class="text-success fw-bold">
            ✅ All slots created for the next 7 days.
          </p>
        </div>
...
export default {
  ...
  methods: {
    ...
    calculateMissingDates() {
      ...
      const slotDates = (this.slots || []).map(s =>
