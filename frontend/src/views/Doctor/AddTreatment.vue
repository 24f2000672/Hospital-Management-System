<template>
    <main>
        ...
        <p>Welcome to your dashboard! Here you can view your upcoming appointments and manage your profile.</p>
        <div class="dashboard-section">
            <h2>Upcoming Appointments</h2>
            <ul>
                <li v-for="appointment in appointments" :key="appointment.id">
                    <strong>{{ appointment.doctor_name }}</strong> - {{ formatDate(appointment.date)
                    }} at {{ appointment.time }}
                </li>
            </ul>
        </div>
